...
const WHITE_NAMES: NamePool = {
  first: [
    ...
    "Lawson", "Dixon", "Beckett", "Spencer", "Fletcher", "Cooper", "Carter",
    "Parker", "Turner", "Garner", "Varner", "Larson", "Gentry", "Heston",
    "Remington", "Pendleton", "Addison", "Garrison", "Harrison", "Patterson", "Jamison",
    "Dennison", "Morrison", "Rollins", "Collins", "Hollins", "Mullins", "Rawlings",
    "Stallings", "Hastings", "Jennings", "Cummings", "Flemings", "Branning", "Manning",
    "Fanning", "Tanning", "Weber", "Cassidy", "Emerson", "Marshall", "Sterling",
    "Booker", "Truett", "Camden", "Wilder", "Ledger", "Maverick", "Justice",
    "Beckham", "Ridge", "Case", "Fox", "Hollis", "Otto", "Vance",
    "Rowdy", "Bodie", "Chandler", "Dodge", "Ellis", "Griffith", "Huck",
    "Ike", "Jett", "Kellan", "Loman", "Mickey", "Nash", "Wilkes",
    "Yates", "Rylan", "Jaxton",
  ],
  last: [
    "Fairbanks", "Garrity", "Hollenbeck", "Ingersoll", "Janssen", "Kirkpatrick", "Lindquist",
    "Mabrey", "Nordstrom", "Oakley", "Quillen", "Radford", "Stapleton", "Thurman",
    "Vandergrift", "Whitaker", "Yancey", "Brennan", "Doyle", "Ekstrom", "Granger",
    "Hollister", "Isley", "Jorgensen", "Kessler", "Lockridge", "Merritt", "Norwood",
    "Pruitt", "Renner", "Vollmer", "Harrington", "Calloway", "Whitmore", "Tillman",
    "Daley", "Briggs", "Langford", "Pruett", "Weston", "Caldwell", "Davenport",
    "Hathaway", "Hargrove", "Wainwright", "Ramsey", "Whitfield", "Langley", "Callahan",
    "Pennington", "Stafford", "Holloway", "Harmon", "Prescott", "Ashford", "Gallagher",
    "Covington", "Dunbar", "Fairfield", "Stratton", "Holbrook", "Stanfield", "Mercer",
    "Ashton", "Templeton", "Carmichael", "Whitlow", "Kincaid", "Winslow", "Redmond",
    "Calhoun", "Ledbetter", "Stovall", "Holcomb", "Braddock", "Ridgeway", "Colfax",
    "Ashby", "Hutchins", "Rutledge", "Sinclair", "Ambrose", "Cavanaugh", "Eastwood",
    "Farnsworth", "Hargis", "Norcross", "Upshaw", "Duckworth", "Ellsworth", "Jessup",
    "Kirtland", "Larrabee", "Northcutt", "McCoy", "Pickens", "Autry", "Hardin",
    "Slaton", "Kilby", "Odell", "Ledet", "Bearden", "Ratliff", "Sasser",
    "Tolar", "Bickford", "Cauthen", "Denney", "Eubank", "Farr", "Goolsby",
    "Hovis", "Isbell", "Justiss", "Kirksey", "Loden", "Massengill", "Nail",
    "Odum", "Poteet", "Rimes", "Sturdivant", "Tolliver", "Upton", "Vardaman",
    "Wardlaw", "Yarber", "Zellars", "Bassham", "Coggins", "Boykin", "Suttles",
    "Roper", "Wooten", "Register", "Segars", "Prine", "Loyd",
  ],
};
